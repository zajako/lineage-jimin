...
public class L1HouseLocation {
	...
	public static boolean isInHouseLoc(int houseId, int locx, int locy,
		...
		case 262146:
			...
			break;
		case 262147:
			if (locx >= 33392 && locx <= 33405 && locy >= 32650
					&& locy <= 32658 && mapid == 4
					|| mapid == 5070) {
				ret = true;
			}
		...
		case 262149:
			...
			break;
		case 262150:
			if (locx >= 33454 && locx <= 33467 && locy >= 32648
					&& locy <= 32656 && mapid == 4
					|| mapid == 5073) {
				ret = true;
			}
		...
		case 262153:
			...
			break;
		case 262154:
			if (locx >= 33421 && locx <= 33434 && locy >= 32685
					&& locy <= 32692 && mapid == 4
					|| mapid == 5077) {
				ret = true;
			}
		...
		case 262157:
			if (locx >= 33372 && locx <= 33385 && locy >= 32692
					&& locy <= 32699 && mapid == 4
					|| mapid == 5080) {
				ret = true;
			}
		...
		case 262161:
			...
			break;
		case 262162:
			if (locx >= 33338 && locx <= 33351 && locy >= 32704
					&& locy <= 32712 && mapid == 4
					|| mapid == 5085) {
				ret = true;
			}
		...
		case 262165: 
			...
			break;
		case 262166: 
			if (locx >= 33401 && locx <= 33414 && locy >= 32733
					&& locy <= 32740 && mapid == 4
					|| mapid == 5089) {
				ret = true;
			}
		...
		case 262169: 
			...
			break;
		case 262170:
			if (locx >= 33363 && locx <= 33376 && locy >= 32755
					&& locy <= 32762 && mapid == 4
					|| mapid == 5093) {
				ret = true;
			}
		...
		case 262178:
			...
			break;
		case 262179: 
			if (locx >= 33373 && locx <= 33386 && locy >= 32822
					&& locy <= 32830 && mapid == 4
					|| mapid == 5102) {
				ret = true;
			}
		...
		case 262186: 
			...
			break;
		case 262187: 
			if (locx >= 33372 && locx <= 33385 && locy >= 32867
					&& locy <= 32874 && mapid == 4
					|| mapid == 5110) {
				ret = true;
			}
			break;
		case 262188:
			if (locx >= 33425 && locx <= 33438 && locy >= 32865
					&& locy <= 32872 && mapid == 4
					|| mapid == 5111) {
				ret = true;
			}
