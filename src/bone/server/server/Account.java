...
public class Account {
	...
	public static Account create(final String name, final String rawPassword,
		...
		try {
			...
			String sqlstr = "INSERT INTO accounts SET login=?,password=password(?),lastactive=?,access_level=?,ip=?,host=?,banned=?,charslot=?,gamepassword=?,point_time=?,Point_time_ready=?";
