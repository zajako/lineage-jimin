...
import bone.server.server.model.L1HateList;
import bone.server.server.model.L1Inventory;
import bone.server.server.model.L1Magic;
import bone.server.server.model.L1MobGroupInfo;
import bone.server.server.model.L1MobSkillUse;
import bone.server.server.model.L1NpcRegenerationTimer;
import bone.server.server.model.L1NpcChatTimer;
import bone.server.server.model.L1NpcTalkData;
import bone.server.server.model.L1Object;
import bone.server.server.model.L1Spawn;
...
import bone.server.server.serverpackets.S_NPCPack;
...
import bone.server.server.utils.TimerPool;
import static bone.server.server.model.item.L1ItemId.*;
