...
import bone.server.server.datatables.PetItemTable;
...
import bone.server.server.model.L1GroundInventory;
...
import bone.server.server.serverpackets.S_PetMenuPacket;
import bone.server.server.serverpackets.S_PetPack;
import bone.server.server.serverpackets.S_ServerMessage;
import bone.server.server.templates.L1Npc;
import bone.server.server.templates.L1Pet;
import bone.server.server.templates.L1PetItem;
...
public class L1PetInstance extends L1NpcInstance {
	...
	public int getCurrentPetStatus() {	return _currentPetStatus;	}

	public int getItemObjId() {	return _itemObjId;	}

	public void setExpPercent(int expPercent) {	_expPercent = expPercent;	}
	public int getExpPercent() {	return _expPercent;	}
	...
	public void setHitByWeapon(int i) {	_hitByWeapon = i;	}
	public int getHitByWeapon() {	return _hitByWeapon;	}

	public void setDamageByWeapon(int i) {	_damageByWeapon = i;	}
	public int getDamageByWeapon() {	return _damageByWeapon;	}
	
	public int getFood() {	return _Food;	}
	public void setFood(int i) {	_Food = i;	}

	public int getFoodTime() {	return _FoodTime;	}
	public void setFoodTime(int i) {	_FoodTime = i;	}
