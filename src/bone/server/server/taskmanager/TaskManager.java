package bone.server.server.taskmanager;

import static bone.server.server.taskmanager.TaskTypes.TYPE_GLOBAL_TASK;
...
import bone.server.server.ThreadPoolManager;
import bone.server.server.taskmanager.tasks.TaskRestart;
import bone.server.server.taskmanager.tasks.TaskShutdown;
