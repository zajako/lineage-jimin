...
import bone.server.server.templates.L1Drop;
import bone.server.server.utils.SQLUtil;

//Referenced classes of package bone.server.server.templates:
...
public class DropTable {
	...
	public void dropShare(L1NpcInstance npc, ArrayList<?> acquisitorList, ArrayList<?> hateList, L1PcInstance pc) {
		...
		for (int i = inventory.getSize(); i > 0; i--) {
			...
			if (((Config.AUTO_LOOT != 0) || (item.getItem().getItemId() == L1ItemId.ADENA)// && pc.isPointUser())
					|| item.getItem().getItemId() == 40044 || item.getItem().getItemId() == 40045 || item.getItem().getItemId() == 40046
					|| item.getItem().getItemId() == 40047 || item.getItem().getItemId() == 40048 || item.getItem().getItemId() == 40049
					|| item.getItem().getItemId() == 40050 || item.getItem().getItemId() == 40051 || item.getItem().getItemId() == 40052
					|| item.getItem().getItemId() == 40053 || item.getItem().getItemId() == 40054 || item.getItem().getItemId() == 40055
					|| item.getItem().getItemId() == 40093 || item.getItem().getItemId() == 40094 || item.getItem().getItemId() == 140074
					|| item.getItem().getItemId() == 240074 || item.getItem().getItemId() == 40074 || item.getItem().getItemId() == 40087
					|| item.getItem().getItemId() == 140087 || item.getItem().getItemId() == 240087 || item.getItem().getItemId() == 140100
					|| item.getItem().getItemId() == 40913 || item.getItem().getItemId() == 40914 || item.getItem().getItemId() == 40915
					|| item.getItem().getItemId() == 40397 || item.getItem().getItemId() == 40398 || item.getItem().getItemId() == 40399
					|| item.getItem().getItemId() == 40400
					|| item.getItem().getItemId() == 40916 || item.getItem().getItemId() == 40710 || (item.getItem().getItemId() >= 40131 && item.getItem().getItemId() <= 40135))// 토템
							...
							if (acquisitor instanceof L1PcInstance) {
								...
								if (l1iteminstance != null && l1iteminstance.getCount() > 2000000000) {
									targetInventory = L1World.getInstance().getInventory(acquisitor.getX(),
											acquisitor.getY(), acquisitor.getMapId()); // 가질 수  없기 때문에 발밑에 떨어뜨린다
									isGround = true;
									player.sendPackets(new S_ServerMessage(166,
											"소지하고 있는 아데나", "2,000,000,000을 초과하고 있습니다.")); 
								} else {
