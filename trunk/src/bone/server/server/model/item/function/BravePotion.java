...
import static bone.server.server.model.skill.L1SkillId.HOLY_WALK;
import static bone.server.server.model.skill.L1SkillId.MOVING_ACCELERATION;
...
import static bone.server.server.model.skill.L1SkillId.WIND_WALK;
	...
	public void clickItem(L1Character cha, ClientBasePacket packet){
		if(cha instanceof L1PcInstance){			
			...
			if ((itemId == L1ItemId.POTION_OF_EMOTION_BRAVERY // 치우침 이브 일부
					...
					useBravePotion(pc, itemId);				
			} else if (itemId == L1ItemId.UGDRA_FRUIT && (pc.isDragonknight() || pc.isIllusionist())) { // 유그드라열매				
					useFruit(pc, itemId);				
			} else {
