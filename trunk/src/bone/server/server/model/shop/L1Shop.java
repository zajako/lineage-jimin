 ...
 */
package bone.server.server.model.shop;
...
import bone.server.server.model.L1TaxCalculator;
...
import bone.server.server.templates.L1ShopItem;
...
public class L1Shop {
	...
	private boolean ensurePremiumSell(L1PcInstance pc, L1ShopBuyOrderList orderList) {
		...
		if (!IntRange.includes(price, 0, 20000)) {
			pc.sendPackets(new S_SystemMessage("신비한 날개깃털은 한번에 20000개 이상 사용할수 없습니다."));
			return false;
		}
