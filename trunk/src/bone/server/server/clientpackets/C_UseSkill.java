...
import static bone.server.server.model.skill.L1SkillId.CALL_CLAN;
import static bone.server.server.model.skill.L1SkillId.CUBE_BALANCE;
...
import static bone.server.server.model.skill.L1SkillId.FIRE_WALL;
import static bone.server.server.model.skill.L1SkillId.FOU_SLAYER;
import static bone.server.server.model.skill.L1SkillId.LIFE_STREAM;
import static bone.server.server.model.skill.L1SkillId.MASS_TELEPORT;
import static bone.server.server.model.skill.L1SkillId.MEDITATION;
import static bone.server.server.model.skill.L1SkillId.RUN_CLAN;
import static bone.server.server.model.skill.L1SkillId.SCALES_EARTH_DRAGON;
import static bone.server.server.model.skill.L1SkillId.SCALES_FIRE_DRAGON;
import static bone.server.server.model.skill.L1SkillId.SCALES_WATER_DRAGON;
import static bone.server.server.model.skill.L1SkillId.TELEPORT;
import static bone.server.server.model.skill.L1SkillId.TRUE_TARGET;
